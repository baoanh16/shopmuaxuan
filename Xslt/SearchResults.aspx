	...
	<div class="container">
		<div class="search-page">
			<div class="search-page-top">
				...
				<asp:Panel ID="pnlSearch" CssClass="form-inline searchcontrols" DefaultButton="btnDoSearch"
					runat="server">
					<div class="form-group">
						<asp:TextBox ID="txtSearchInput" CssClass="form-control" runat="server" MaxLength="255">
						</asp:TextBox>
						<label for="ctl00_mainContent_btnDoSearch" runat="server">
							<span class="mdi mdi-magnify"></span>
						</label>
					</div>
					<asp:Button CssClass="btn btn-default seachpage-btn" ID="btnDoSearch" runat="server"
